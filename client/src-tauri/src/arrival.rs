...
///     practical purposes ASA-ACARS has no geometry for *any* heliport.
///
...
/// pad, or the real corpus case ASA 22 (planned EDLD — which has a runway row
...
mod tests {
    ...
    /// ASA-ACARS has ever recorded, evaluated at its actual final parked
    ...
    /// was and reported 7 false positives that turned out to be real. ASA 0
    ...
    ///
    ///     AEROACARS_CORPUS=/root/Claude/asa-acars-src/corpus-arrivals.csv \
    ...
    fn a_field_without_runway_geometry_is_located_via_the_reference_point() {
        ...
        // Real corpus case (ASA 22): shut down 143 nm from EDLD and the client
