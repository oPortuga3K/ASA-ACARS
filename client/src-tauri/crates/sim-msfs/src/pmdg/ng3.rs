...
pub struct Pmdg738RawData {
    ...
    // ============================================================
    // Mode control panel — INTERESTING for ASA-ACARS
    // ============================================================
...
// ---------------------------------------------------------------
// Higher-level "useful subset" — what ASA-ACARS actually consumes.
// ---------------------------------------------------------------
...
/// ASA-ACARS actually consumes for activity logging, PIREP fields,
