...
**Scope**: Wie ASA-ACARS die Landing-Rate (vertical speed at touchdown) berechnet, warum sie genauer ist als das was die zwei dominanten Konkurrenten (SimCARS und Volanta) machen, und wo die Schwächen unseres Ansatzes liegen

---

## TL;DR

| Aspekt | Volanta v1.17.2 | SimCARS v1.1.58 | **ASA-ACARS** |
|---|---|---|---|
...
## C. ASA-ACARS — was wir machen und warum
...
ASA-ACARS unterscheidet ab v0.1.26 explizit zwischen **Touch-and-Go**
