...
Story für die User:
> ASA-ACARS v0.2.0 — Boeing Premium Telemetry
...
**UI-Integration:**
- ASA-ACARS detected PMDG geladen + ClientData kommt nicht (Subscribe meldet keine Daten innerhalb 5s)
...
> Du fliegst eine PMDG 737/777, aber ASA-ACARS bekommt keine erweiterten Cockpit-Daten. Aktiviere den PMDG SDK:
>
> 1. Schließe MSFS
...
> ASA-ACARS unterstützt die PMDG SimConnect-SDK für 737 NG3 und 777X. PMDG ist ein eingetragenes Markenzeichen von Precision Manuals Development Group; ASA-ACARS ist nicht von PMDG entwickelt oder offiziell endorsed.
