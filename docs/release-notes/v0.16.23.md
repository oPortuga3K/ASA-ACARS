...
- **SimBrief-Username automatisch aus dem phpVMS-Profil.** Hast du in den
  ASA-ACARS-Einstellungen noch keinen SimBrief-Identifier hinterlegt, holt
  sich ASA-ACARS deinen SimBrief-Username aus deinem phpVMS-Profil (sofern
...
- **VPS-Recorder:** ein erneutes Laden der geplanten Route auf dem
  asa-acars-live-Recorder, damit die externe Live-Map dieselbe korrigierte
  Strecke übernimmt.
...
- **SimBrief username auto-sourced from your phpVMS profile.** If you
  haven't set a SimBrief identifier in ASA-ACARS settings yet, ASA-ACARS
...
- **VPS recorder:** a re-fetch of the planned route on the asa-acars-live
