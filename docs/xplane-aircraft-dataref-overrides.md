...
**Zweck:** ASA-ACARS liest seine X-Plane-Telemetrie über Standard-`sim/...`-DataRefs.
...
ASA-ACARS „sah" die Flaps nie → `LANDING CONFIG: INCOMPLETE`.
...
dann kann ASA-ACARS ein Aircraft-Profil dafür bekommen.
...
(`sim/flightmodel/forces/local_vx` / `local_vz`), die ASA-ACARS für die
...
| Funktion | Standard-DataRef (ASA-ACARS heute) | Typ / erwarteter Wert | Wirkung in ASA-ACARS | Aircraft-spezifischer DataRef |
|---|---|---|---|---|
...
| Funktion | Standard-DataRef (ASA-ACARS heute) | Typ / erwarteter Wert | Aircraft-spezifischer DataRef |
|---|---|---|---|
...
gesetzt sind. ASA-ACARS behandelt das ab v0.12.1 fail-soft (LANDING CONFIG =
...
liefert `0,1,2,3` (entspricht Flaps 0 / 1 / 20 / 30), ASA-ACARS erwartet aber
