...
Ziel ist: ASA-ACARS soll bei Fenix A319/A320/A321 Cockpit-Zustaende besser lesen koennen, ohne in das Flugzeug einzugreifen.
...
- bestehende ASA-ACARS-Cockpit-State-Felder genauer fuellen
...
ASA-ACARS soll ein Beta-Profil aktivieren, wenn die aktuelle MSFS-Maschine eindeutig Fenix A32x ist.
...
| # | Szenario | Erwartung |
|---|---|---|
| Q1 | Fenix nicht installiert | ASA-ACARS laeuft normal, kein Fehler |
...
| Q6 | Beacon on/off | ASA-ACARS erkennt Wechsel |
| Q7 | Landing Lights on/off | ASA-ACARS erkennt Wechsel |
| Q8 | Strobe/Taxi/Nav | ASA-ACARS erkennt Wechsel soweit gemappt |
| Q9 | Seatbelt/No Smoking | ASA-ACARS erkennt Wechsel soweit gemappt |
...
```text
Wir testen eine Fenix A32x Beta fuer ASA-ACARS.
...
Ziel ist, ASA-ACARS-Logs und Cockpit-State-Erkennung fuer Fenix zu verbessern.

Die Beta ist freiwillig und standardmaessig deaktiviert — wer den Schalter in den Settings nicht anklickt, merkt nichts davon. Wenn etwas nicht erkannt wird, bleibt ASA-ACARS im normalen MSFS-Modus.
