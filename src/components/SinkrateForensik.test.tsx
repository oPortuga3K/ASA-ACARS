...
// ───────────────────────────────────────────────────────────────────────────
// ASA-218-Fixture (Live-DB-Werte, Spec §8.3)
// ───────────────────────────────────────────────────────────────────────────
const GSG_218 = {
...
// ───────────────────────────────────────────────────────────────────────────
// v0.7.20 ASA-219 QS-Befund: forensics_version-aware Notice-Text-Branch
// ───────────────────────────────────────────────────────────────────────────
...
describe("computeBuckets — Disjoint-Bucket-Differenz", () => {
  it("ASA-218: korrekte Bucket-Werte aus Live-DB-Fixture", () => {
...
describe("isMonotonAccelerating — Trend ueber BETRAG", () => {
  it("ASA-218: |155|→|218|→|284|→|343| alle Deltas >20 = true", () => {
    const buckets = computeBuckets(-229, -266, -314, -344, -343)!;
...
describe("pickCoachingTip — Prioritaet (erster Match gewinnt)", () => {
  it("ASA-218: flare_lost wegen monoton beschleunigendem Trend", () => {
    const buckets = computeBuckets(-229, -266, -314, -344, -343)!;
...
describe("vsTone — Bands nach landingScoring.ts:128-131", () => {
  ...
  it("|343| → neutral (< 400, ASA-218-Fall)", () => expect(vsTone(-343)).toBe("neutral"));
...
// ───────────────────────────────────────────────────────────────────────────
describe("ASA-218 End-to-End — kompletter Fixture-Trockenlauf (Spec §8.3)", () => {
