...
pub const TELEMETRY_FIELDS: &[TelemetryField] = &[
    ...
    // Pilot-Befund Michael 2026-05-26: ASA-ACARS Auto-Start scheiterte mit
...
fn telemetry_to_snapshot(t: Telemetry, simulator: Simulator) -> SimSnapshot {
    ...
    // 2532 ein, ASA-ACARS meldet weiterhin 2000 (oder einen
    ...
    SimSnapshot {
        ...
        // current ASA rotorcraft + flying-boat seaplanes) and water/vertical
...
mod tests {
    ...
    fn b002_fenix_transponder_code_suppressed_regardless_of_simvar() {
        ...
        // zurueck gibt, blendet ASA-ACARS ihn aus.
        let mut t = Telemetry::default();
        t.title = "FenixA320 CFM SL".into();
        t.atc_model = "A320".into();
